/**
 * The swapi people rest interface.
 */
export interface IRestPeople {
    /**
    ...
    /**
     * The next data source url or null if no next.
     */
    next: string | null;

    /**
     * The previous data source url or null if no previous.
     */
     previous: string | null;

     /**
      * The actual people data.
      */
    results: IPeople[];
}

/**
 * The People model to use with SWAPI.
 */
